    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0"> Catalogues List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                        <li class="breadcrumb-item active"> Catalogues List</li>
                    </ol>
                </div>
                    ...
                    <table id="example"
                        ...
                        @foreach($catalogues as $catalogue)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.catalogues.show', $catalogue->id) }}" class="btn btn-info mb-3">Xem</a>
                                    <a href="{{ route('admin.catalogues.edit', $catalogue->id) }}"
                                       class="btn btn-warning mb-3">Sửa</a>

                                    <a href="{{ route('admin.catalogues.destroy', $catalogue->id) }}"
